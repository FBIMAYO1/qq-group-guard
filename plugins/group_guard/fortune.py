...
FORTUNE_POOL = [
    ("大吉", 5, [
        "南极仙企亲赐大吉！今天做什么都顺，鱼会自己跳进你嘴里。",
        "大吉大利！冰面之下暗流涌动，但你能在暗流中捉到最大的鱼。",
        "大——吉——！企鹅长老说今天是你全年最旺的一天。",
    ]),
    ("吉", 15, [
        "吉签到手！今天运气不错，企鹅保佑你一切顺利。",
        "吉星高照，走路都会踩到好运气。",
        "吉！企鹅在冰面上给你画了个好运圈。",
    ]),
    ("中吉", 25, [
        "中吉，不好不坏。就像南极的天气——不出太阳但也不下暴风雪。",
        "比上不足比下有余，企鹅觉得这样挺好。",
        "中吉。平静的一天，冰面稳固，适合发呆。",
    ]),
    ("小吉", 25, [
        "小吉。今天会有小确幸，比如抢到最后一个红包。",
        "微吉，聊胜于无，企鹅给你加块冰。",
        "小吉。企鹅觉得你嘴角会上扬至少一次。",
    ]),
    ("末吉", 20, [
        "末吉……今天做事要小心，别像企鹅一样在冰面上滑倒。",
        "签运平平，建议多喝热水少作死。",
        "末吉。冰面有点滑，但还不至于掉下去。谨慎前行！",
    ]),
    ("凶", 10, [
        "凶！今天出门小心，别踩到海豹尾巴。建议宅一天。",
        "凶签。企鹅建议你今天老实待着，少说话多吃鱼。",
        "大凶之兆！但企鹅在南极见过更糟的天气——暴风雪过后总会天晴的。",
    ]),
]
...
async def handle_fortune(bot: Bot, event: GroupMessageEvent):
    ...
    if user_id in _daily_fortunes[group_id]:
        await fortune_cmd.finish(
            f"[CQ:at,qq={user_id}] 你今天在本群已经抽过签了。\n"
            f"明天再来吧，企鹅一天只算一次命。"
        )
