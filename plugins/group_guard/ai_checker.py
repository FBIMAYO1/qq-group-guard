...
{"violation": true/false, "category": "辱骂"或"R18"或"暴力"或"违法"或"政治"或"炼铜"或"赌博"或"反伦理", "reason": "原词拼音=xx → 还原为=xx"}
{"violation": false, "category": "", "reason": ""}

示例：
输入"有没有月抛的" → {"violation": true, "category": "R18", "reason": "月抛拼音=yuepao ≈ 约炮 色情邀约"}
输入"来玩bc" → {"violation": true, "category": "赌博", "reason": "bc=菠菜 赌博黑话"}
输入"瑟琴" → {"violation": true, "category": "R18", "reason": "瑟琴拼音=seqin ≈ 色情"}
输入"吃了没" → {"violation": false, "category": "", "reason": ""}"""
