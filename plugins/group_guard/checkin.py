...
STREAK_REWARDS = {
    7: [
        "咕咕嘎嘎！连续7天签到，你比其他人类勤快一点点。",
        "一周签到达成！企鹅给你记在小本本上了。咕咕嘎嘎！",
        "咕咕嘎嘎！7天领到的冰砖数量：1块。不够再说。",
    ],
    30: [
        "咕咕嘎嘎！整整一个月签到，南极冰面都被你踩薄了。",
        "30天全勤！凑企鹅表示勉强认可你。咕咕嘎嘎！",
        "咕咕嘎嘎！一个月没断签，你比企鹅还能坚持。",
    ],
    100: [
        "咕咕嘎嘎！！100天！你是企鹅见过最固执的人类。",
        "百天签到达成！企鹅决定赏你一条冷冻鱼。咕咕嘎嘎！",
        "咕咕嘎嘎！100天连签，南极长老会注意到你了。",
    ],
    365: [
        "咕咕嘎嘎！！！365天全年签到！！！企鹅族谱上从此有你的名字。",
        "一年连签！你已经是半个企鹅了。咕咕嘎嘎！身份证稍后发放。",
    ],
}

DAILY_REWARDS = [
    "咕咕嘎嘎！签到成功，今天又活了一天。",
    "滴——打卡成功。企鹅冷漠地看了你一眼。咕咕嘎嘎！",
    "签到！企鹅从冰水里探出头表示看到了。咕咕嘎嘎！",
    "咕咕嘎嘎！签到打卡，南极冰面留下你的脚印。",
    "打卡完成！企鹅叼来一条鱼作为奖励（然后又叼走了）。咕咕嘎嘎！",
    "咕咕嘎嘎！签到成功。凑企鹅在此盖章确认。",
]
...
async def handle_checkin(bot: Bot, event: GroupMessageEvent):
    ...
    if not is_first:
        await checkin_cmd.finish(
            f"[CQ:at,qq={user_id}] 咕咕嘎嘎！你今天已经签过了。\n"
